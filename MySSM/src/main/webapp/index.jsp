						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_update_input" placeholder="email@cwl.com">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="email" class="form-control"
									id="email_add_input" placeholder="email@cwl.com">
								<span class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		...
		function validate_add_form(){
	        ...
	        if (!regName.test(empName)) {
	             //alert("用户名为2-5中文或4-16英文数字组合");
	             show_validate_msg("#empName_add_input","error","用户名为2-5中文或6-16英文数字组合（前）");
	            
	           // show_validate_msg("#empName_add_input","error","用户名为2-5中文或6-16英文数字组合");
	            return false;
	        }else {
